function [matlabbatch]=rstp(flibasedir,atlasdir,outputdir)
...
cd(wd);
batchfileid = fopen('batchtorun.m','w');
specformat = 'matlabbatch{1}.spm.spatial.realign.estimate.data = ''%s '' \n';
